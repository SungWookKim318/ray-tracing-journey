...
impl Noise for HermitianPerlin {
...
impl HermitianPerlin {
    pub fn new(rng: &mut dyn rand::Rng) -> Self {
        Self {
            ...
            perm_x: HermitianPerlin::create_perlin_perm(rng),
            perm_y: HermitianPerlin::create_perlin_perm(rng),
            perm_z: HermitianPerlin::create_perlin_perm(rng),
        }
    }
}
